...
df(Array,'\xF0',function(x,y){x=fb(x,Boolean);if(x instanceof Array)y=x,x=function(a){return y.includes(a)};x=functify(x,y);for(var a=[],i=0;i<this.length;i++)if(x(this[i],fb(y,i),this))a.push(i);return a});
