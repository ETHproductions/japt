...
df(Array,'g',function(){for(var a=this,i=0,x;x=arguments[i],typeof x==="number";i++)a=a[pm(fb(x,0),a.length)];if(arguments[i]instanceof Array)a=arguments[i++].map(function(j){return a.g(j)});if(i===0)a=a[0];return a});
